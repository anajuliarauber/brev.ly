  ...
  return (
    <>
      <div className="bg-white rounded-lg p-6 shadow">
        ...
        <ScrollArea.Viewport className="h-auto max-h-[550px]">
            {isListLoading ? (
          ...
          <ScrollArea.Scrollbar orientation="vertical" className="w-2 bg-gray-200 rounded-full">
            <ScrollArea.Thumb className="bg-blue-base rounded-full" />
